...
Then the pair $\langle\ \overset{S^{\mathcal{C}}, \mathcal{C}}{\leq},\ \mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\ \rangle$ defines a chain $\mathcal{C}/S^{\mathcal{C}$ with length $\big|\mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\big|$.
