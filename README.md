...
Then the pair $\langle\ \overset{S^{\mathcal{C}}, \mathcal{C}}{\leq},\ \mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\ \rangle$ defines a chain which we will denote using the following notation $\langle\mathcal{S}\mathcal{C} \backslash S^{\mathcal{C}}\rangle$.  Obviously, $\mathcal{S}\mathcal{C} \backslash S^{\mathcal{C}}$ has a length $\big|\ \mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\big|$.
