...
Then the pair $\langle\ \overset{S^{\mathcal{C}}, \mathcal{C}}{\leq},\ \mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\ \rangle$ defines a chain which will denote with the following notation $\mathcal{S}\mathcal{C}/S^{\mathcal{C}}$.  Obviously, $\mathcal{S}\mathcal{C}/S^{\mathcal{C}}$ has a length $\big|\mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\big|$.
