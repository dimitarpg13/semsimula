...
Then the pair $\ \overset{S^{\mathcal{C}}, \mathcal{C}}{\leq},\ \mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\ $ defines a chain which we will denote using the following notation $\langle\mathcal{S} \cup \mathcal{C} \backslash S^{\mathcal{C}}\rangle$.  Obviously, $\langle\mathcal{S} \cup \mathcal{C} \backslash S^{\mathcal{C}}\rangle$ has a length $\big|\ \mathcal{S} \cup \left(\mathcal{C} \backslash S^{\mathcal{C}}\right)\big|$.
